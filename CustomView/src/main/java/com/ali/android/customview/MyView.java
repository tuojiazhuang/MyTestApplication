package com.ali.android.customview;
...
public class MyView extends View {
    ...
    public  MyView(Context context, AttributeSet attributeSet){
        ...
        TypedArray a = context.obtainStyledAttributes(attributeSet, R.styleable.MyView);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawCircle(centerX+centerY, centerX+centerY, r, paint);
