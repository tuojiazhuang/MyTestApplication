...
public class ContentData {
    public static final String AUTHORITY = "com.ali.android.contentproviderapp";
    ...
    public static final class UserTableData implements BaseColumns {
        ...
        public static final String CONTENT_TYPE = "vnd.android.cursor.dir/com.ali.android.teachers";
        // 单一数据的MIME类型字符串应该以vnd.android.cursor.item/开头
        public static final String CONTENT_TYPE_ITME = "vnd.android.cursor.item/com.ali.android.teacher";
        /* 自定义匹配码 */
