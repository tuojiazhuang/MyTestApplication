...
public class MainActivity extends FragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        MyLog.myPrint("MainActivity>onCreate");
    ...
    protected void onResume() {
        super.onResume();
        MyLog.myPrint("MainActivity>onResume");
    }

    @Override
    protected void onRestoreInstanceState(Bundle savedInstanceState) {
        super.onRestoreInstanceState(savedInstanceState);
        MyLog.myPrint("MainActivity>onRestoreInstanceState");
    }

    @Override
    protected void onStart() {
        super.onStart();
        MyLog.myPrint("MainActivity>onStart");
}

    @Override
    protected void onStop() {
        super.onStop();
        MyLog.myPrint("MainActivity>onStop");
    }

    @Override
    protected void onDestroy() {
        super.onDestroy();
        MyLog.myPrint("MainActivity>onDestroy");
    }

    @Override
    protected void onSaveInstanceState(Bundle outState) {
        super.onSaveInstanceState(outState);
        MyLog.myPrint("MainActivity>onSaveInstanceState");
    }
